 ...
 * @method static array listDocuments(string $indexName, int|string $limit = 10, int|string $offset = 0, ?string $filter = null)
 * @method static array search(string $indexName, array $searchQuery, ?int $size = null, ?int $from = null)
 * @method static array suggest(string $indexName, string $text, ?string $field = null, int|string|null $size = null)
